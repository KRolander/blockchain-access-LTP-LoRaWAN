...
data = pd.read_csv('capture_n1_sending_24_bytes_without_ltl.csv')
...
#print("mes courants max sont :",c0,c2)	
cmoy0=cmoy0/i0
cmoy2=cmoy2/i2	
#print("mes courants moy sont :",cmoy0,cmoy2)	
...
plt.tight_layout()
# Show the plot
plt.savefig("fig1_without_ltl_with_sensors_current.png")
plt.show()

with open('legend_current_sending_24_bytes_without_ltl.csv', 'w', newline='') as file24bytes:
